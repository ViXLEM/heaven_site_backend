# Generated by Django 4.0.6 on 2023-07-26 17:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_name', models.CharField(choices=[('OF', 'OnlyFans'), ('AD', 'AnastasiaDating'), ('DM', 'DateMe'), ('CD', 'CharmDate'), ('J4', 'JumpForLove'), ('GB', 'GoldenBride'), ('RM', 'RomansCompass'), ('PM', 'PrimeDate')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Table',
